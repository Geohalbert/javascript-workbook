...
function rockPaperScissors(hand1, hand2) {
  ...
  if (typeof(hand1) === 'number') {
    return "hand1 is a number datatype";
  } else if (typeof(hand2) === 'number') {
    return "hand2 is a number datatype";
  }
  if (!lHand1) {
...
if (typeof describe === 'function') {
  ...
  describe('#rockPaperScissors()', () => {
    ...
    it('should detect when the input is a number', () => {
      assert.equal(rockPaperScissors(2, 'rock'), "hand1 is a number datatype");
      assert.equal(rockPaperScissors('paper', 3), "hand2 is a number datatype");
    });
